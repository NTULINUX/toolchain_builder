...
cmake \
    -DCMAKE_C_FLAGS="-O3 -march=x86-64-v3 -rtlib=compiler-rt -unwindlib=libunwind -Wno-unused-command-line-argument" \
    -DCMAKE_CXX_FLAGS="-O3 -march=x86-64-v3 -rtlib=compiler-rt -unwindlib=libunwind -stdlib=libc++ -Wno-unused-command-line-argument" \
