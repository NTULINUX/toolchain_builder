...
cmake \
    ...
    -DLLVM_TOOLCHAIN_TOOLS="llvm-ar;llvm-ranlib;llvm-objdump;llvm-rc;llvm-nm;llvm-strings;llvm-readobj;llvm-objcopy;llvm-strip;llvm-cov;llvm-addr2line;llvm-symbolizer;llvm-ml;llvm-readelf;llvm-size;llvm-cxxfilt;llvm-lib" \
    "${LTO[@]}" \
    ..
